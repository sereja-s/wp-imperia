...
<defs>
<linearGradient id="paint0_linear_34_251" x1="1750" y1="0" x2="1750" y2="3500" gradientUnits="userSpaceOnUse">
...
<rect width="35" height="35" fill="white"/>
					...
					<div class="col-md-5 footer-center text-center">
						<div class="one-men"><h2>Каталог</h2><?php wp_nav_menu( [ 'menu' => 'Main' ] ); ?></div>
						<div class="one-men"><h2>Для клиента</h2><?php wp_nav_menu( [ 'menu' => 'Top bar' ] ); ?></div>
					</div>
                    <div class="col-md-4 footer-right text-left">
                        <?php echo do_shortcode('[contact-form-7 id="da96fd3" title="Подписка"]');?>
						...
						<div class="whats" style="display:none"><a target="_blank" href="<?php the_field('whatsapp','option');?>"><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<div class="whats" style="display:none"><a target="_blank" href="<?php the_field('telegram','option');?>"><svg width="35" height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<rect width="35" height="35" fill="white"/>
 	...
 	<div class="copy"><div class="container"><div class="row">
				<div class="copywrite"><?php the_field('copy','option');?></div>
				<a href="/dogovor-oferty/">Договор оферты</a>
				<a href="/politika/">Политика конфиденциальности</a>
		<a href="/privacy/">Согласие на обработку персональных данных</a>
					</div>
			</div></div>      
<dialog class="pop" id="pop-up">
  <?php echo do_shortcode('[contact-form-7 id="7577e22" title="Заказать звонок"]');?>
	<button class="close"><i class="oco-modal__header-close-ico">
...
const showButton = document.getElementById("pop-up-open");
...
<script>
(function() {
    // Отправляем цель только один раз за сессию
    function sendCartGoal() {
        if (sessionStorage.getItem('ym_cart_view_99728249')) {
            
            return;
        }
        
        // Отправляем именно вашу цель
        ym(99728249, 'reachGoal', 'просмотр корзины');
        sessionStorage.setItem('ym_cart_view_99728249', 'true');
