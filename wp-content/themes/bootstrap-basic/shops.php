...
*/
?>
<?php get_header(); $main_column_size = bootstrapBasicGetMainColumnSize(); ?> 
...
<?php 
	...
	<div class="row">
		...
		<?php if( have_rows('магазины') ): while ( have_rows('магазины') ) : the_row(); ?>					
		<div class="entry-content row one-shop">
							
							<div class="col-md-4 cont-4">
								<h2><?php the_sub_field('название');?></h2>
							<div class="phone-b"><a href="tel:<?php the_sub_field('телефон');?>"><?php the_sub_field('телефон');?></a></div>
						<div class="address"><?php the_sub_field('адрес');?></div>
...
<rect width="20" height="20" fill="white"/>
							...
							<div class="col-md-8 cont-8"><?php echo get_sub_field('map');?></div>
