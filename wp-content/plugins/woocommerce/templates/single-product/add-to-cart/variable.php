...
<form class="variations_form cart" action="<?php echo esc_url(apply_filters('woocommerce_add_to_cart_form_action', $product->get_permalink())); ?>" method="post" enctype='multipart/form-data' data-product_id="<?php echo absint($product->get_id()); ?>" data-product_variations="<?php echo $variations_attr; // WPCS: XSS ok. 
	...
	<?php else : ?>
		...
		<span class="a2233">* Цены на товары могут отличаться от указанных на сайте. Для получения актуальной информации о стоимости и наличии товаров свяжитесь с нами<br>* Реальный внешний вид и технические характеристики товаров могут отличаться от представленных на сайте. Уточняйте важные для вас параметры товаров у наших продавцов</span>
