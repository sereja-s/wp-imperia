...
class OptionsPage extends AbstractModule
{
    public function boot(): void
    {
        ...
        add_action('admin_footer-plugins.php', [$this, 'renderDeactivationForm']);
    }
    ...
    public function renderDeactivationForm(): void
    {
        echo View::render('deactivation_form');
    }
    ...
    private function initRoutes(): void
    {
        ...
        $this->router->addRoute(Route::make('qodax_checkout_manager_feedback', SettingsController::class, 'sendFeedback'));
    }
}