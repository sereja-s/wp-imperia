		...
		if ( version_compare( get_option( 'wppp_version', '0' ), $this->version, '<' ) ) :
			...
			if ( version_compare( get_option( 'wppp_version', '0' ), '1.2.0', '<' ) ) :
				$dropdown_options_default =
					( apply_filters( 'loop_shop_columns', 3 ) * 3 ) . ' ' .
					( apply_filters( 'loop_shop_columns', 3 ) * 6 ) . ' ' .
					( apply_filters( 'loop_shop_columns', 3 ) * 9 );
				...
				update_option( 'wppp_shop_columns', isset( $settings['shop_columns'] ) ? $settings['shop_columns'] : '3'  );
