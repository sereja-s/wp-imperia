		...
		$data_arr = [ 
			...
			[ 
				...
				'data' => [ 
					...
					'desc' => sprintf( '%s utm_campaign. %s {catid} %s {productid}',
						__( 'UTM tag', 'yml-for-yandex-market-pro' ),
			...
			[ 
				...
				'tab' => 'filtration_tab',
				'data' => [ 
					'label' => __( 'Additional information', 'yml-for-yandex-market-pro' ),
					'desc' => __( 'UTM tag', 'yml-for-yandex-market-pro' ) . ': utm_content',
					'woo_attr' => false,
					'key_value_arr' => [ 
						[ 'value' => 'catid', 'text' => __( 'Category ID', 'yml-for-yandex-market-pro' ) ],
						[ 'value' => 'productid', 'text' => __( 'Product ID', 'yml-for-yandex-market-pro' ) ]
					]
				]
			],
			[ 
			...
			[ 
				...
				href="https://icopydoc.ru/kak-filtrovat-tovary-po-nazvaniyu-brenda-instruktsiya/?utm_source=yml-for-yandex-market-pro&utm_medium=organic&utm_campaign=in-plugin-yml-for-yandex-market-pro&utm_content=settings&utm_term=skip-vendor"
				target="_blank">%s</a>',
			...
			[ 
				...
				'data' => [ 
					'label' => '',
					'desc' => __(
						'Set to 9999 to not use this filter',
						'yml-for-yandex-market-pro'
					),
					'placeholder' => '9999',
					'min' => '-1',
