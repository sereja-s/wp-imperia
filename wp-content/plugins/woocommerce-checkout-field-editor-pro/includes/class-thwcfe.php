...
class THWCFE {
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action( 'admin_enqueue_scripts', $plugin_admin, 'enqueue_styles_and_scripts',10 );
		...
		$this->loader->add_action('admin_footer', $plugin_admin,'fb_collection_links',10);
