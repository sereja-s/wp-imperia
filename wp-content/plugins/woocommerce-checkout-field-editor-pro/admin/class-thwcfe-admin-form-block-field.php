...
class THWCFE_Admin_Form_Block_Field extends THWCFE_Admin_Form{
	...
	public function get_field_form_props(){
		...
		$hint_default_date = "Specify a date in the yyyy-MM-dd date format, or number of days from today (e.g. +7) or a string of values and periods ('y' for years, 'm' for months, 'w' for weeks, 'd' for days, e.g. '+1m +7d'), or leave empty for today.";
		$hint_date_format = "The format for parsed and displayed dates. MM/dd/yyyy, dd/MM/yyyy, yyyy-MM-dd, dd MMMM yyyy, EEE, dd MMM yyyy, dd/MM/yy are all valid.";
		$hint_min_date = "The minimum selectable date. Specify a date in yyyy-MM-dd format, or number of days from today (e.g. -7,+7) or a string of values and periods ('y' for years, 'm' for months, 'w' for weeks, 'd' for days, e.g. '-1m -7d'), or leave empty for no minimum limit.";
		...
		$hint_year_range = "The range of years displayed in the year drop-down: choose any positive number (e.g.10), to restrict which dates may be selected use the minDate and/or maxDate options.";
		...
		return array(
			...
			'date_format'  => array('type'=>'text', 'name'=>'date_format', 'label'=>'Date Format', 'value'=>'yyyy-MM-dd', 'hint_text'=>$hint_date_format),
			...
			'year_range'   => array('type'=>'text', 'name'=>'year_range', 'label'=>'Year Range', 'value'=>'100', 'hint_text'=>$hint_year_range),
