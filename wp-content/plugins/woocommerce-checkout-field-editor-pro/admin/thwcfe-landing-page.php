 ...
 * Admin Base HTML.
 *
 * @package Themehigh\skyro-woocommerce-checkout\admin
 */
...
<html <?php language_attributes(); ?>>
	...
	<body class="thwcfe-admin-page thwcfe-landing-page wp-core-ui">
		<div id="th_render_landing_page">
			<div class="th-landing-page-content">
				...
				<a href="<?php echo esc_url(admin_url('admin.php?page=th_checkout_field_editor_pro&tab=fields&c_type=classic')); ?>" class="th-get-started-btn">
					...
					<div class="th-diff-box-wrap">
						<div class="th-diff-box">
							<div class="th-diff-box-content">
								...
								<img src="<?php echo esc_url(THWCFE_ASSETS_URL_ADMIN . 'css/checkout-img.png'); ?>" alt="Classic Checkout">
							</div>
						...
						<div class="th-diff-box">
							...
							<div class="th-diff-box-content">
								...
								<img src="<?php echo esc_url(THWCFE_ASSETS_URL_ADMIN . 'css/block-checkout.png'); ?>" alt="Block Checkout">
							</div>
							
						</div>	
					</div>
					<div class="th-btn-box">
						<a href="<?php echo esc_url(admin_url('admin.php?page=th_checkout_field_editor_pro&tab=fields&c_type=classic')); ?>" class="th-choose-btn">
							<?php esc_html_e('Go with Classic Checkout Editor', 'woocommerce-checkout-field-editor-pro') ?>
						</a>
						<a href="<?php echo esc_url(admin_url('admin.php?page=th_checkout_field_editor_pro&tab=fields&c_type=block')); ?>" class="th-choose-btn">
